                    ...
                    <form className="enter-form__content" onSubmit={submitHandleLogin}>
                        <div className="enter-form__content__inputs">
                            <div htmlFor="email" className="input__wrap">
                                ...
                                <TextField variant="standard" label="Email" data-testid="email" value={email} onChange={emailHandleChange} type="email" name="email" className="input__field" placeholder="mail@mail.ru" required></TextField>
                            </div>
                            <div htmlFor="password" className="input__wrap">
                                {/* <div className="input__title">Пароль</div> */}
                                <TextField variant="standard" label="Пароль" value={password} onChange={passwordHandleChange} type="password" name="password" className="input__field" placeholder="*************" data-testid="password" required></TextField>
                            </div>
                        </div>
